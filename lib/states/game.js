...
module.exports = {
  ...
  init: function (stage, current, playerPositionInPreviousScreen) {
    this.stage = stage
  ...
  generateEntities: function (screen) {
    ...
    this.generatedEntities = screen.entities.map(([ entity, ...args ]) => {
      return entities[entity].apply(this, args)
    })
  },
  update: function () {
    this.playerMovement()
  ...
  changeToScreen: function (screen, playerCenter, resetX, resetY) {
    ...
    game.state.start(
      ...
      /*clearWorld=*/true,
      /*clearCache=*/false,
      /*...args*/ this.stage, this.screen, { playerCenter: playerCenter.clone(), resetX, resetY })
  },
